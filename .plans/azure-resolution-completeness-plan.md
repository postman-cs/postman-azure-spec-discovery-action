...
| the customer-style `GithubOrg`/`GithubRepo` selection | Yes | Yes | No | P0 validation gap |
...
The the customer-style tag path exists but does not yet satisfy the production contract.
